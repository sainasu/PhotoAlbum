...
- (instancetype)init
{
        ...
        if (self) {
                ...
                self.colorsArray = [NSArray arrayWithObjects:
                                    UIColorFromHex(0xffffff,1.0),
                                    UIColorFromHex(0xc0c0c0,1.0),
                                    UIColorFromHex(0x5e5e5e,1.0),
                                    UIColorFromHex(0x000000,1.0),
                                    UIColorFromHex(0xff6119,1.0),
                                    UIColorFromHex(0xffa21d,1.0),
                                    UIColorFromHex(0xf6f700,1.0),
                                    UIColorFromHex(0x8eff00,1.0),
                                    UIColorFromHex(0x28fa77,1.0),
                                    UIColorFromHex(0x54e7df,1.0),
                                    UIColorFromHex(0x47c3fd,1.0),
                                    UIColorFromHex(0x485eff,1.0),
                                    UIColorFromHex(0xc33cff,1.0),
                                    UIColorFromHex(0xff3880,1.0),
                                    UIColorFromHex(0xff150c,1.0) , nil];
